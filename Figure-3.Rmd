...
```{r}
data<-bind_rows(amdo,dependo,erythro,ichthama, proto, unc, uns)
...
ggsave("outputs/figure-3/figure-3.pdf", height=11, width=8.5)
ggsave("outputs/figure-3/figure-3.eps", height=11, width=8.5)
ggsave("outputs/figure-3/figure-3.png", height=11, width=8.5)
...
ggsave("outputs/figure-3/figure-3-orders.pdf", height=11, width=8.5)
#ggsave("outputs/figure-3/figure-3-orders.eps", height=11, width=8.5)
ggsave("outputs/figure-3/figure-3-orders.png", height=11, width=8.5)
```
